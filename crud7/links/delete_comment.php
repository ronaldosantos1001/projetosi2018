...
<?php
    if(isset($_COOKIE['id']) && isset($_COOKIE['security'])){
        ...
        if(isset($_GET['comment_id'])){
          $del = delete_comment($_GET['comment_id']);
        }
...
<?php
  ...
  ?>
    <button type="button" class="btn btn-primary btn-sm pull-right btn-post-comment" data-toggle="modal" data-target="#exampleModalCenter">
