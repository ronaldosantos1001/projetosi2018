...
<?php
  ...
  if(isset($_COOKIE['id']) && isset($_COOKIE['security'])){
    ...
    include("includes/navbar.php");
        ...
        $db = new mysqli();
          $db->connect("localhost", "root", "", "social_media");
            ...
            <h2><?php echo $post_title; ?></h2>
                <div class="w3-card-4 cards-bkg" style="width:100%">
                  ...
                  <form action="index.php" method="post">
                    ...
                    <button type="submit" class="btn btn-danger pull-left" name="delete">Apague a postagem</button>
                  </form>
                <a href="./links/edit.php?post_id=<?php echo $post_id; ?>" class="btn btn-primary pull-right">Editar post</a>
              </div>
        </div>
          <?php } ?>
      </div>
